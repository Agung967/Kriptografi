 ...
 * @author Agung
 */
public class appenkripsi extends javax.swing.JFrame {

    /**
     * Creates new form appenkripsi
     */
    public appenkripsi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("ISI kata kunci");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(appenkripsi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new appenkripsi().setVisible(true);
            }
        });
    }
